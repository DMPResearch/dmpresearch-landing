...
export const careers = {
  ...
  contact: {
    ...
    text: 'A few lines on what you build, two links, and the kind of work you want more of. We read every note and reply within a week either way.',
    bookHint: 'No need to book a sales call. A clear note with links is enough.',
    formTitle: 'Apply to contract',
    formText: 'Name, a way to reach you, and what you would want to pick up. Links carry more weight than a long message.',
    formSuccess: 'Got it. We will read your links and reply within a week.',
    showCalendly: false,
    fields: {
      name: 'Name',
      email: 'Email',
